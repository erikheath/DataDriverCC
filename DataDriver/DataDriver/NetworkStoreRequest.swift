...
public protocol NetworkStoreRequest: NSObjectProtocol {
    ...
    /**
     A completion block that should be executed at the completion of a transaction.
     */
    var completionHandler: (Void -> Void)? { get set }

    /**
     An object that should serve as the delegate for the transaction generated by the request.
     */
    var transactionDelegate: TransactionDelegate? { get set }
